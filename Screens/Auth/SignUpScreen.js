...
// onSubmit={(values ) => {
//    Alert.alert(JSON.stringify(values.email));
...
//   setIsLoading(true);
//   await   dispatch(authactions.createRegister(values));
    ...
    <StatusBar backgroundColor='#7c2b83' barStyle="light-content"/>
      ...
      autoCorrect = {false}
          ...
          {touched.conformpassword && errors.conformpassword &&
              <Text style={{ fontSize: 10, color: 'red' }}>{errors.conformpassword  }</Text>
            }
